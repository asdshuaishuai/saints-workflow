...
|                                 Development Phase                               |
| +-------------+    +-------------------+    +---------------+                 |
| | Yuanshi     |    | Tongtian          |    | Duobao        |                 |
| | Orthodox    |    | Opposing          |    | Core Arch     |                 |
| +-------------+    +-------------------+    +---------------+                 |
+--------------------------------------------------------------------------------+
             |                    |                |
             +--------+-----------+                v
...
| +------------+  --->  +------------+                                                |
| | Fuxi       |       | Nuwa       |                                                |
| | Flaw Detect|       | Defect Fix |                                                |
| +------------+       +------------+                                                |
+--------------------------------------------------------------------------------+
                                |   | 
                                v   v
+--------------------------------------------------------------------------------+
|                              Dual Review + Heavenly Dao Loop                    |
| +------------+   +------------+   +------------+                                |
| | Zhunti     |   | Jieyin     |   | Heavenly Dao|                                |
| | Code Review|   | Business   |   | Final Check |                                |
| +------------+   +------------+   +------------+                                |
+--------------------------------------------------------------------------------+
```
